...
class BaseFeeder(data.Dataset):
    def __init__(self, prefix, gloss_dict, text_dict,tokenizer,drop_ratio=1, num_gloss=-1, mode="train",dataset = '', transform_mode=True,
        ...
        data_txt = f"/home/gaoliqing/shipeng/code/slrBert/DatasetFile/dialogue_csldaily/{mode}.txt"
